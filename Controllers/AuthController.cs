...
namespace carsaApi.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(IWebHostEnvironment webHostEnvironment, IMapper mapper, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IConfiguration config, CarsaApiContext context
                     )
        {
